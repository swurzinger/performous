...
find_path(SWResample_INCLUDE_DIR
  NAMES libswresample/swresample.h ffmpeg/swresample.h swresample.hS
...
if(SWResample_INCLUDE_DIR)
  ...
  endforeach(suffix)
    ...
    if(NOT SWResample_INCLUDE)
    message(FATAL_ERROR "Found swresample.h include dir, but not the header file. Perhaps you need to clear CMake cache?")
  endif(NOT SWResample_INCLUDE)
